      ...
      <div className="mx-auto max-w-6xl px-5">
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((service) => (
            <article
              key={service.id}
              className="group relative flex flex-col overflow-hidden rounded-3xl bg-white p-7 shadow-sm ring-1 ring-plum-200/50 transition duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:shadow-blush-200"
            >
              {service.popular && (
              ...
              <div className="flex items-start justify-between">
                ...
                <span className="rounded-full bg-plum-50 px-3 py-1 text-xs font-semibold text-plum-600">
                  ⏱ {service.duration}
                </span>
              </div>
              ...
              <div className="mt-5 flex items-center justify-between border-t border-plum-100 pt-5">
                <div className="flex items-end gap-1">
                  ...
                  <span className="pb-1 text-sm text-plum-500">บาท</span>
                </div>
              </div>
              <Link
                to="/booking"
                className="mt-4 rounded-full border-2 border-blush-300 py-2.5 text-center text-sm font-semibold text-blush-600 transition hover:border-blush-500 hover:bg-blush-500 hover:text-white"
              >
                จองบริการนี้
              </Link>
            </article>
